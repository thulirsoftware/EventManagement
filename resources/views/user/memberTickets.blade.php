	...
	@for($i=0; $i<$noOfEvents; $i++)
	    ...
	    <div class="col-md-6">
	          ...
	          <div class="input-group col-md-6" style="margin-top: 30px">
	              <a href="/memberBuyTicket/{{ $events[$i]['id'] }}" style="background-color: #ff6100;color:black;padding:15px;text-decoration: none;border-radius: 5px" ><span class="text">Buy Ticket</span></a>
