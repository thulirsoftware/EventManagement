      ...
      <div class="row">
        ...
        <div class="col-md-6">
         ...
         <div class="col-md-6">
          <div class="form-group">
            ...
            <input id="zip" type="text" style="border-radius: 4px" class="form-control" maxlength="5" name="address1" value="{{ $member['addressLine1'] }}" required>
        ...
        <div class="col-md-6">
          <div class="form-group">
            ...
            <input id="zip" type="text" style="border-radius: 4px" class="form-control" maxlength="5" name="address2" value="{{ $member['addressLine2'] }}" required>
