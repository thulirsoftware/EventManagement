        ...
        <div class="col-md-9 col-md-offset-3">
            <div class="panel">
               ...
               <div class="panel-body col-md-offset-0" style="background-color:#f3f4c6;padding-top:35px">
                  ...
                  <div class="form-group">
                    <label class="control-label col-sm-3 col-md-offset-1" for="dobDate">DOB Day:</label>
                    <div class="col-sm-5 col-md-offset-0">
                  ...
                  <div class="form-group">
                    <label class="control-label col-sm-3 col-md-offset-1" for="dobMonth">DOB Month:</label>
                    <div class="col-sm-5 col-md-offset-0">
