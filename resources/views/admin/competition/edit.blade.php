                ...
                <div class="row">
                  <div class="col-md-6 form-group">
                    ...
                    <label for="Description">Member Fees :</label>
                      <input type="text"  value="{{ $competition['member_fee'] }}" class="form-control" id="member_fee" placeholder="Enter Member Fee" name="member_fee" required>
                    </div>
                     <div class="col-md-6 form-group">
                    <label for="Description">Non Member Fees :</label>
                      <input type="text" value="{{ $competition['non_member_fee'] }}" class="form-control" id="non_member_fee" placeholder="Enter Non Member Fee" name="non_member_fee" required>
                    </div>
                  <div class="col-md-6 form-group">
                    ...
                    <label for="Description">Closing Date:</label>
                      <input type="date" class="form-control" id="closing_date" placeholder="Enter Closing Date" name="closing_date" value="{{ $competition['closing_date'] }}" required>
                    </div>
