        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body p-0">
                    ...
                    <?php
                        $body = \DB::table('email_cfgs')->where('name','donation')->value('body');
                ?>
                   <div class="row pb-5 p-5">
                        <div class="col-md-12">
                              <?php
                                $campaign = \App\Campaign::where('id',$donation->campaign_id)->first();
                            ?>
                            @if($campaign!=null)
                                We have received a donation of {{$donation->amount}} for the campaign {{$campaign->name}} . Thanks for your contribution.
                             @else
                              We have received a donation of {{$donation->amount}} for the general . Thanks for your contribution.
