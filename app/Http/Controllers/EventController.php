...
class EventController extends Controller
{
    ...
    public function eventTickets($id)
    {
        ...
        $VipJudgeTickets = VipJudgeTickets::where('event_id',$id)->get();

         return view('admin.event.tickets',compact('eventFoodTicket','eventTicket','Competition','events','event','id','Purchased_Entry_Tickets','Purchased_Food_Tickets','CompetitionRegistration','VipJudgeTickets'));
    }
